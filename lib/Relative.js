...
Relative.prototype.isOverlay = function isOverlay(container, overlayTest) {
...
Relative.prototype.findElements = function findElements(layer, isPosition, layers) {
    var elements = [];
    ...
    findPosition(this.structure.parent);
...
Relative.prototype.isChildOf = function isChildOf(layer, parent) {
...
Relative.prototype.moveLayers = function moveLayers() {
    ...
    function move(layers) {
        layers.slice().forEach(function (layer) {
            ...
            innerElements = _this.findElements(layer, _this.isInner);
            ...
            */
            ...
            innerElements = innerElements.filter(function (element) {
                ...
                if (undefined !== moved[element.id]) {
                    ...
                    if (_this.isChildOf(layer, moved[element.id])) {
