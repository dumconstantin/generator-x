...
Structure.prototype.optimisePositioning = function () {
    ...
    var relativeStructure = new Relative(this.parent);

    relativeStructure.setRows();
    relativeStructure.refreshTree();
    relativeStructure.parseContainers();
    relativeStructure.parseRows();
    relativeStructure.modifyElements();

    relativeStructure.showTree();
   ...
   // console.log(showTree(result));
    ...
    return;
    console.log(JSON.stringify(logStructure(createNewNodes(result)), null, ' '));
