            ...
            cells.forEach(function (row, rowIndex, rows) {
                row.forEach(function (col, colIndex, cols) {
                    ...
                    if (0 !== colIndex) {
                        ...
                        cell.leftGap = marginRight - (cellWidth - (prev.element.css.width + prev.leftGap));
                    ...
                    if (0 !== rowIndex) {
                        ...
                        cell.bottomGap = marginBottom - (cellHeight - (prev.element.css.height + prev.bottomGap));
                        ...
                        cell.inlineBlockAdjustment = prevRowHeight - prev.h + prev.inlineBlockAdjustment;
