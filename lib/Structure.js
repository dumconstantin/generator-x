        ...
        if (2 <= elementsNo) {
            ...
            rows.forEach(function (col, index) {
                ...
                col.forEach(function (cell) {
                    ...
                    rowWidths[index] += cell.element.css.width;
            ...
            var marginRight = (parent.css.width - rowWidths[0]) / (cols - 1),  
            ...
            cells.forEach(function (row, rowIndex, rows) {
                row.forEach(function (col, colIndex, cols) {
                    ...
                    if (0 !== colIndex) {
                        ...
                        cell.leftGap = marginRight - (cellWidth - (prevW + prevLeftGap));
                    ...
                    if (colIndex < cols.length - 1) {
                        cell.element.css.marginRight = Math.floor(marginRight);
                    }
