...
//         log(siblings, 'row finished');
    ...
    function removeAdvancedAbsolute(parent) {
        ...
        // We need at least two elements to create a visual relationship.
        if (2 <= elementsNo) {
            ...
            cells.forEach(function (row, rowIndex, rows) {
                row.forEach(function (col, colIndex, cols) {
                    ...
                    if (0 !== rowIndex) {
                        ...
                        topDiff = rowIndex * cellHeight + cell.bottomGap;
                    }
    ...
    // orderByRow(this.parent.siblings);
    // orderByColumn(this.parent.siblings);
