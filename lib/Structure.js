...
//         log(siblings, 'row finished');
    ...
    console.log('Now we can apply the grid!');
    ...
    function getPaddings(element) {
        ...
        element.siblings.forEach(function (sibling) {
            console.log(sibling.css.left + ' + ' + sibling.css.right + ' + ' + sibling.css.width);
            top.push(sibling.css.top - element.css.top);
            left.push(sibling.css.left - element.css.left);
            right.push(element.css.width - (sibling.css.right - element.css.left));
            bottom.push(element.css.height - ((sibling.css.top - element.css.top)+ sibling.css.height));
        });
    ...
    getPaddings(this.parent.siblings[0]);
